    ...
    def on_message(self, client, userdata, msg):
        ...
        try:
            ...
            if command in ["ON", "OFF"]:
                ...
                room_padded = str(room).zfill(4)
                pbx_cmd = f"..ROOM{room_padded}={val}\r\n"
    ...
    async def run(self):
        ...
        try:
            while True:
                ...
                # Send Heartbeat to prevent PBX from disconnecting (Timeout is 60s)
                if self.pbx_writer:
                    await self.send_to_pbx("..VERS=\r\n")
